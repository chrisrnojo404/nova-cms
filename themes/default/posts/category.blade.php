...
@section('content')
    <div class="max-w-3xl">
        <p class="text-xs font-semibold uppercase tracking-[0.28em] text-cyan-600 dark:text-cyan-400">Category archive</p>
        <h1 class="mt-4 text-5xl font-semibold tracking-tight text-slate-900 dark:text-white">{{ $category->name }}</h1>
        <p class="mt-5 text-lg leading-8 text-slate-600 dark:text-slate-300">{{ $category->description ?: 'Browse posts in this category.' }}</p>
    </div>
